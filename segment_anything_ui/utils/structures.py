...
class BoundingBox:
    ...
    @classmethod
    def from_drawn_bounding_box(
        cls, 
        drawn_bounding_box: DrawnBoundingBox, 
        label: str, 
        mask_width: int, 
        mask_height: int
    ) -> "BoundingBox":
        return cls(
            x_min=drawn_bounding_box.xstart / mask_width,
...
class Annotation:
    ...
    def adjust_mask_id(self, shift: int):
...
class Annotations:
    ...
    def append_bounding_box(self, bounding_box: BoundingBox):
        annotation = Annotation(
