...
from segment_anything_ui.modeling.efficientvit.models.efficientvit.backbone import (
    EfficientViTBackbone,
    EfficientViTLargeBackbone)
from segment_anything_ui.modeling.efficientvit.models.nn import (
    ConvLayer,
    DAGBlock,
    FusedMBConv,
    IdentityLayer,
...
from segment_anything_ui.modeling.efficientvit.models.utils import get_device
...
def efficientvit_sam_l2(image_size: int = 512, **kwargs) -> EfficientViTSam:
    from segment_anything_ui.modeling.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l2
